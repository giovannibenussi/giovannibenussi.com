...
pubDate: "Dec 04 2020"
heroImage: "../../assets/blog/css-modules-on-create-react-app/css-modules-cra.png"
---

[CSS Modules](https://github.com/css-modules/css-modules) are great when building components because it allows you to create locally scoped class names so you don't need to worry about naming conflicts. This is the definition that [the official CSS Modules repository](https://github.com/css-modules/css-modules) provides:

> A CSS Module is a CSS file in which all class names and animation names are scoped locally by default.

I'm not going to dig on the specific features of CSS Modules (maybe more of that on another post!), but instead talk about how to use it on [create-react-app](https://create-react-app.dev/).
...
You can also use a library like [classnames](https://github.com/JedWatson/classnames) or [clsx](https://github.com/lukeed/clsx):
